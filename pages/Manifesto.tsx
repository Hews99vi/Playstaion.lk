...
const Manifesto: React.FC = () => {
  return (
    <div className="relative min-h-screen overflow-hidden py-40">
      ...
      <div className="max-w-5xl mx-auto px-10 relative z-10 space-y-32">
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div className="flex items-center gap-4">
            <div className="w-12 h-[1px] bg-blue-500"></div>
            <span className="text-[10px] font-black tracking-[1em] text-blue-500 uppercase">Core Directive</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center animate-in fade-in slide-in-from-bottom-20 duration-1000 delay-300">
          <p className="text-2xl text-white/40 font-light leading-relaxed uppercase tracking-tight italic">
          ...
          <div className="space-y-12">
            <div className="flex gap-8 group">
              <Shield className="w-10 h-10 text-blue-500 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity" />
              <div>
            ...
            <div className="flex gap-8 group">
              <Cpu className="w-10 h-10 text-blue-500 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity" />
              <div>
            ...
            <div className="flex gap-8 group">
              <Target className="w-10 h-10 text-blue-500 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity" />
              <div>
        ...
        <div className="pt-32 border-t border-white/5 text-center space-y-12">
          <div className="flex justify-center gap-20 opacity-10">
